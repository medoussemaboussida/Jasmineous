        ...
        <!-- Spinner End -->
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="commande.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Commande</a>
                    ...
                    <a href="table.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Categorie</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data" onsubmit="return CTRL()">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"name="nom_cat" id="nom_cat" placeholder="nom du categorie" minlength="1" maxlength="20">
                                </div>
    ...
    //alpha commence avec majuscule
            ...
            <div class="container-fluid pt-4 px-7">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-10">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Liste des categories </h6>
                            <table class="table">
                            <!--------LES METIERS--------->
                            <!--generer pdf-->
                            <form method="POST" action="pdfCat.php" align="left">
                            ...
                            &nbsp; <button type="submit"  class="btn btn-primary" for="TrieCat">Trier par : </button>&nbsp;
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="DeleteCategorie.php?id_cat=<?php echo $categorie['id_cat']; ?>"><button class="btn btn-primary">Supprimer</button></a><center>    
                </td>
                    <td>
                    <form method="POST" action="UpdateCategorie.php" align="center">
