                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action=""method="POST" onsubmit="return CTRL()" enctype="multipart/form-data" >
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nom_cat" id="nom_cat" placeholder="nom du categorie" minlength="1" maxlength="20" value="<?php if (isset($_POST['id_cat'])){ 
                                ...
                                <input type="submit"  class="btn btn-primary" id="Modifier" name="modif" value="Modifier"> 
