<?php
    ...
    if (isset($_POST['ajout'])) {
        ...
        {
            $listeseance = $seanceCRUD->Rechercher($_POST['RechercheNom']);
        }
        else{
            $error = "Missing information";
        }
       ...
       {  
           ...
           if ($Trier == "Type croissant")
           {
               $listeseance = $seanceCRUD->TriePrixASC();
           }
           else
           {
               $listeseance = $seanceCRUD->TriePrixDESC();
           }
       }
       else{
           $error = "Missing information";
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data" onsubmit="return CTRL()">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="type_seance"  name="type_seance">
                                </div>
                                <div id="error_type_seance" style="color:red"></div>
                                <div class="mb-3">
                                    <label for="dure_seance">Dure_Seance :</label><br>
                                    <input type="number" class="form-control" id="dure_seance"  name="dure_seance">
                                </div>
                                <div id="error_dure_seance" style="color:red"></div>
                                            
                                
                                <div class="mb-3">
                                    <label for="nbr_maximal">Nombre(max):</label>
                                    <input type="number" class="form-control" name="nbr_maximal" id="nbr_maximal">
                                </div>
                                ...
                                <div id="error_categorie" style="color:red"></div>
                                <div class="mb-3">
                                    <label for="image_seance">Image :</label>
                                    <input type="file" name="image_seance" id="image_seance" accept=".jpg, .jpeg, .png, .gif">
                                </div>
...
<br>
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" align="center">
                              &nbsp;<button type="submit" class="btn btn-primary" for="Trie">Trier par : </button>&nbsp;
                               <select type="range" name="Trie" id="Trie">
                                     ...
                                     <option>Type croissant</option>
                                     <option>Type décroissant</option>
                                </select>
                             </form>  
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $seance['type_seance']; ?></td>
                <td><?php echo $seance['dure_seance']; ?></td>
                <td><?php echo $seance['nbr_maximal']; ?></td>
                <td><?php echo $seance['categorie']; ?></td>
                <td> <img src="<?php echo $seance['image_seance'];?>" class="img-fluid rounded service-image" alt="author image"></td>
                <td>
                    <a href="DeleteSeance.php?id_seance=<?php echo $seance['id_seance']; ?>"><button class="btn btn-primary">Supprimer</button></a><center>    
                </td>
                    <td>
                    <form method="POST" action="UpdateSeance.php" align="center">
