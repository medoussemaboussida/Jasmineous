    ...
    if (isset($_POST['modifierrr'])) {
        ...
        if (
            ...
            if (
                ...
                $programes->Modifierprogram($program,$_POST['id_demande']);
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Modifier program</h6>
                            <?php
                            if (isset($_POST['id_demande'])){
                                $program = $programCRUD->Recupererprogram($_POST['id_demande']);
                            ...
                            <form action=""method="POST" onsubmit="return CTRL()" enctype="multipart/form-data" >
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="type_demande" id="type_demande" placeholder="type de demande" value="<?php echo $program['type_demande']; ?>" >
                                </div>
                                <div id="error_type_demande" style="color:red"></div>
                                <div class="mb-3">
                                    <label for="Desc_diet">Description diet :</label><br>
                                    <input type="text" class="form-control"  name="Desc_diet" id="Desc_diet" placeholder="Desc_diet" value="<?php echo $program['Desc_diet']; ?>" >
                                </div>
                                <div id="error_Desc_diet" style="color:red"></div>
                            
                                <div class="mb-3">
                                    <label for="Desc_workout">Description workout :</label>
                                    <input type="text" class="form-control" name="Desc_workout" id="Desc_workout" value="<?php echo $program['Desc_workout']; ?>">
                                </div>
                                ...
                                <input type="hidden" name="id_demande" value="<?php echo $program['id_demande']; ?>" >
                                                               ...
                                                               function CTRL()
                                {
                                   ...
                                   var letters = /^[A-Za-z]+$/;
                                    ...
                                    if(type_demande=="")
                                    {
                                        ...
                                        if(Desc_diet=="")
                                    {
                                        error_Desc_diet.innerHTML="Il faut saisir la description du diet !";  
                                        test=1;
                                    }
                                    else 
                                        if(!Desc_diet.match(letters))
                                        {
                                            error_Desc_diet.innerHTML="Il faut que le diet contient que des lettres !";  
                                            test=1;
                                        }
                                        else
                                        { error_Desc_diet.style.color="green"
                                            error_Desc_diet.innerHTML="ce champs a ete remplis correctement";
                                          
                                        }

                                        if(Desc_workout=="")
                                    {
                                        error_Desc_workout.innerHTML="Il faut saisir la description workout !";  
                                        test=1;
                                    }
                                    else 
                                        if(!Desc_workout.match(letters))
                                        {
                                            error_Desc_workout.innerHTML="Il faut que le type du demande contient que des lettres !";  
                                            test=1;
                                        }
                                        else
