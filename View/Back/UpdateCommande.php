    ...
    if (isset($_POST['modifierrr'])) {
        ...
        if (
            ...
            isset($_POST['tel'])
                ...
                $commandes->Modifiercommande($commande, $_POST['id_commande']);
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Gestion commande</h6>
                            <?php
                            if (isset($_POST['id_commande'])){
                                $commande = $commandeCRUD->Recuperercommande($_POST['id_commande']);
                            }
                            else
                            {
                                echo"eeee";
            ...
            <tr>
                    ...
                    <td><input type="text" name="panier" id="panier"  maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="f_name" id="f_name"  maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="l_name" id="l_name"  maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="adda">Address:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="adda" id="adda" >
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="code_post">postal:
                        </label>
                    </td>
                    <td>
