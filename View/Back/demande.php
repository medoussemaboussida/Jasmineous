...
$demande= new demandeCRUD();
$listedemande=$demande->Afficherdemande(); 
 ...
 <div class="sidebar pe-4 pb-3">
    ...
    <tbody>
        ...
        <td><?php echo $demande['id_demande']; ?></td>
            <td><?php echo $demande['hauteur']; ?></td>
            <td><?php echo $demande['poids']; ?></td>
            <td><?php echo $demande['age']; ?></td>
          
            <td>
                <a href="Deletedemande.php?id_u=<?php echo $demande['id_u']; ?>"><button class="btn btn-primary">Supprimer</button></a><center>    
            </td>
                <td>
                <form method="POST" action="Updatedemande.php" align="center">
                                                    <a type="submit" name="Modifier" ><button class="btn btn-primary">Modifier</button></a>
                                                    <input type="hidden" value=<?php echo $demande['id_u']; ?> name="id_u">
                                                </form>
            </td>
        </tr>
        <?php endforeach; ?>
