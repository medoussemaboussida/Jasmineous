...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <!-- Spinner End -->
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="panier.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Panier</a>
...
<script src="js/main.js"></script>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $panier['namee']; ?></td>
                <td><?php echo $panier['quantite']; ?></td>
                <td><?php echo $panier['prix_total']; ?></td>
                
                <td>
                    <a href="DeletePanier.php?id_panier=<?php echo $panier['id_panier']; ?>"><button class="btn btn-primary">Supprimer</button></a><center>    
                </td>
