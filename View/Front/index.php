          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                <li class=""><a href="signup.php">Sign Up Here</a></li>
                <li class=""><a href="#about">About</a></li>
                <li class=""><a href="indexchat.php">Chat</a></li>
                <li class=""><a href="#contact">Contact</a></li>
                <li class=""><a href="-logiin.php">Log Out</a></li>
...
<style>
  ...
  <section id="doctor-team" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">Meet Our Coaches</h2>
          <hr class="botm-line">
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>321 Ghazela Street<br> Ariana, AR 17022</p>
          <div class="space"></div>
