...
require "mail.php";
	...
	if(!$con = mysqli_connect("localhost","root","","user_db")){
	...
	function save_password($password){
		...
		$query = "update user_hub set password = '$password' where email = '$email' limit 1";
		mysqli_query($con,$query);
	...
	function valid_email($email){
		...
		$query = "select * from user_hub where email = '$email' limit 1";		
